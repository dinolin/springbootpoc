...
public class ProductTest {
    ...
    public void testGetProduct() throws Exception {
        ProductModel product = createProduct("Economics", 450);
    ...
    public void testSearchProductsSortByPriceAsc() throws Exception {
    	ProductModel p1 = createProduct("Operation Management", 350);
    	ProductModel p2 = createProduct("Marketing Management", 200);
    	ProductModel p3 = createProduct("Human Resource Management", 420);
    	ProductModel p4 = createProduct("Finance Management", 400);
    	ProductModel p5 = createProduct("Enterprise Resource Planning", 440);
    ...
    public void get400WhenReplaceProductWithNegativePrice() throws Exception {
        ProductModel product = createProduct("Computer Science", 350);
        productRepository.insert(product);
    ...
    private ProductModel createProduct(String name, int price) {
